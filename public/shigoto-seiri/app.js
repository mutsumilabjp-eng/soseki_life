(() => {
  ...
  const offerCopy = {
    work: [
      "上司が変わってもこの仕事は続けたくない。そう感じるなら、ほかにどんな仕事内容があるか見てみる方法があります。",
      "次の仕事でもやりたいことと、もう引き受けたくないこと。求人を見る前に一つずつ書いておけます。",
      "まだ応募しなくて構いません。今の会社に残るか考えるためにも、外の条件を一度見ておけます。",
    ],
    environment: [
      "今の上司や部署から離れたら続けられそう。でも異動は難しい。そんなとき、ほかの会社の働き方を見てみる方法があります。",
      "次は、休日の連絡が少ない職場がいい。通勤時間はこれ以上長くしたくない。そんな条件から見てみます。",
      "まだ応募しなくて構いません。今の会社に残るか考えるためにも、外の条件を一度見ておけます。",
    ],
    selfEvaluation: [
      "「自分には今の会社でしか通用しない」と思ったら、やってきた仕事を求人票の言葉と比べてみる方法があります。",
      "部下の育成、取引先との調整、現場の改善。肩書きを外して、実際にやってきたことから探せます。",
      "まだ応募しなくて構いません。今の会社に残るか考えるためにも、外の条件を一度見ておけます。",
    ],
    default: [
      "辞めるかどうかは決まっていない。でも、ほかにどんな会社があるのかだけ知りたい日もあります。",
      "次は、休日の連絡が少ない職場がいい。通勤時間はこれ以上長くしたくない。そんな条件から見てみます。",
      "まだ応募しなくて構いません。今の会社に残るか考えるためにも、外の条件を一度見ておけます。",
    ],
  };
